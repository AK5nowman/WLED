...
value="3" id="cc">Cronixie Clock</option><option value="4" id="cs">Seven Segment
...
Cronixie Backlight: <input type="checkbox" name="CB"><br></div><div id="css">
Display Mask: <input name="ZM" maxlength="8"><br>Display Layout: <input 
name="ZC" type="number" min="0" max="5" required> First LED: <input name="Z1" 
type="number" min="0" max="255" required> LED/seg: <input name="ZS" 
type="number" min="0" max="255" required> LED/dot: <input name="ZP" 
type="number" min="0" max="255" required></div>Countdown Mode: <input 
type="checkbox" name="CE"><br>Countdown Goal:<br>Year: 20 <input name="CY" 
type="number" min="0" max="99" required> Month: <input name="CI" type="number" 
min="1" max="12" required> Day: <input name="CD" type="number" min="1" max="31" 
required><br>Hour: <input name="CH" type="number" min="0" max="23" required>
 Minute: <input name="CM" type="number" min="0" max="59" required> Second: 
<input name="CS" type="number" min="0" max="59" required><br><h3>Macro presets
</h3><b>Macros have moved!</b><br><i>
